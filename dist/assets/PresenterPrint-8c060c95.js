import{d,i as _,a as u,u as h,b as p,c as m,e as f,f as n,g as t,t as o,h as a,F as g,r as v,n as x,j as b,o as i,k as y,l as N,m as k,p as C,q as P,_ as S}from"./index-d78abfad.js";import{N as w}from"./NoteDisplay-b75ebfd8.js";const D={class:"m-4"},V={class:"mb-10"},j={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},L={class:"text-lg"},T={class:"font-bold flex gap-2"},F={class:"opacity-50"},H=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-gray-400/50 mb-8"},A=d({__name:"PresenterPrint",setup(M){_(u),h(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
